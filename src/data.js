...
import Tools5 from "/assets/tools/dart.jpg";
import Tools6 from "/assets/tools/python.png";
import Tools7 from "/assets/tools/js.png";
import Tools8 from "/assets/tools/flask.jpg";
import Tools9 from "/assets/tools/github.png";
import Tools10 from "/assets/tools/git.jpg";
import Tools11 from "/assets/tools/postgree.jpg";
import Tools12 from "/assets/tools/canva.png";
import Tools13 from "/assets/tools/figma.png";
import Tools14 from "/assets/tools/ps.png";
import Tools15 from "/assets/tools/reactjs.png";
import Tools16 from "/assets/tools/tailwind.jpg";
import Tools17 from "/assets/tools/bootstrap.jpg";
...
import Proyek8 from "/assets/proyek/plugpoint.jpeg";
...
export const listProyek = [
  ...
  },
  {
    ...
    gambar: Proyek8,
    nama: "PlugPoint",
    shortDesk: "Prototype Power Bank Rental Application",
    desk: "PlugPoint is a UI/UX design project for a mobile application that provides an online powerbank rental service. The app allows users to easily find rental locations, rent powerbanks, make payments, and collect loyalty points to redeem for rewards. The design focuses on a simple, mobile-friendly interface with a clear user flow from login to transaction confirmation. The project also includes supporting features such as discount vouchers, usage guides, and consistent branding with orange tones and a lightning bolt symbol representing energy and speed.",
    tools: ["Figma"],
    dad: "700",
    slug: "plugpoint"
  },
