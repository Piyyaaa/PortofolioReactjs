...
function ProjectCard({ gambar, nama, shortDesk, tools, delay, slug }) {
  return (
    <div
      className="p-4 bg-zinc-800 rounded-xl shadow-md hover:shadow-2xl hover:shadow-blue-700/40 transform hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between min-h-[550px]"
      data-aos="fade-up"
